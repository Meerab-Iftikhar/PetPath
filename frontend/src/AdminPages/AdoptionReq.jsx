...
const AdoptionReq = () => {
  ...
  useEffect(() => {
    const fetchAdoptionRequests = async () => {
      try {
        const response = await axios.get('${import.meta.env.VITE_API_URL}/api/adopting/adoption-requests');
  ...
  const handleReject = async (id) => {
    try {
      await axios.delete('${import.meta.env.VITE_API_URL}/api/adopting/adoption-requests/${id}');
  ...
  const handleApprove = async (id) => {
    ...
    try {
      const response = await axios.put('${import.meta.env.VITE_API_URL}/api/adopting/adoption-requests/${id}', {
        status: 'Adopted',
      });
